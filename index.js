...
const { v4: uuidv4 } = require("uuid");
const mongoose = require("mongoose");
const BYD_KNOWLEDGE_BASE = require("./knowledgeBase");
...
const CallLog =
  mongoose.models.BYDCallLog || mongoose.model("BYDCallLog", callLogSchema);
...
### BYD VEHICLE KNOWLEDGE ###
Use the following knowledge base as your single source of truth for all vehicle specs, pricing, features, colors, and dealership details. Never state pricing or specs that are not present in this knowledge base.
